...
const TextAnimation: FC = () => {
    ...
    useEffect(() => {
        let ctx = gsap.context(() => {
            ...
            gsap.set("span.default", { opacity: 0.4 });
    ...
    return (
        <>
            ...
            >
                ...
                <div className="mt-2 font-austin text-4xl max-lg:text-2xl max-md:text-xl max-sm:text-lg text-[#E0650D]">
                    <div className="paragragh">
                        {blogs.map((item, index) => {
                            return (
                                <div className="!block mt-[2rem]" key={index}>
                                    {_.map(item, (subItem, idx) => {
                                        return (
                                            <div
                                                key={idx}
                                                style={{ display: "block" }}
