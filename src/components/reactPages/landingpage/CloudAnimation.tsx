        ...
        <>
            <div className="rounded-2xl bg-[#F1FEFE] font-austin mt-4">
                <div className="grid grid-cols-12">
                    <div className="col-span-4 py-10 px-5 sm:px-10 max-lg:col-span-12 bg-[#F1FEFE] z-[31] mr-4 rounded-l-2xl max-lg:hidden">
                        <Transition refElement={tempRef}>
                            ...
                            <div className="border-[#B3B9B3] border-t-[1px] mt-32 w-1/4 max-[1023px]:mt-16"></div>
                            <div className="font-mint text-lg mt-4 max-md:mt-5 max-lg:text-md max-md:text-sm max-[1767px]:text-sm">
                    ...
                    <div className="col-span-8 max-lg:col-span-12 flex z-30 justify-center ml-4 h-[35rem] cloudSection max-lg:ml-0 max-md:scale-90 max-sm:scale-80 max-[500px]:scale-70">
                        <div className="bg-[url('/temp/cloud_frame.svg')] bg-no-repeat bg-[length:100%_100%] absolute w-[57rem] h-[35rem]">
                            <motion.div
                                className="bg-[url('/temp/reschedule.svg')] bg-no-repeat absolute w-60 h-52 z-30 bg-contain ml-56 mt-48 max-md:ml-72 max-[550px]:ml-[23rem]"
                                initial={{
                                    opacity: 0,
                                }}
                                ref={rescheduleRef}
                            />
                            <motion.div
                                className="bg-[url('/temp/new_showing.svg')] bg-no-repeat absolute w-60 h-36 z-30 bg-contain mt-12 ml-[22rem] max-md:ml-[17rem] max-[550px]:ml-[12rem]"
                                initial={{
                                    opacity: 0,
                                }}
                                ref={newShowingRef}
                    ...
                    <div className="hidden py-10 px-5 sm:px-10 max-lg:col-span-12 bg-[#F1FEFE] z-[31] mr-4 rounded-l-2xl max-lg:block">
                        <Transition refElement={backRef}>
                            ...
                            <div className="font-mint text-lg mt-4 max-md:mt-5 max-lg:text-md max-md:text-sm max-[1767px]:text-sm">
                                You have full control over who’s coming to see
                                your home and at what time—and when something comes up,
                                no more contacting a realtor to reschedule.
                            </div>
                            <SecondaryButton
                                hasArrow
                                text="Get Started"
