...
export const NavContainer = styled.div<{ mobile?: boolean }>`
    ...
    align-items: center;
    height: ${(props) => (props.mobile ? "60px" : "92px")};
    max-height: ${(props) => (props.mobile ? "60px" : "92px")};
    min-height: ${(props) => (props.mobile ? "60px" : "92px")};
    border-bottom: 1px solid ${colors.gray200};
`;

const LinkText = styled(MintParagraph)<{ selected: boolean }>`
    color: ${(props) =>
        props.selected ? colors.typographyBlack : colors.gray700};
    border-bottom: ${(props) =>
        props.selected ? `3px solid ${colors.typographyBlack}` : "none"};
...
const MobileIconSvg = () => (
    ...
    >
        <path
            d="M2 10.8589L2 2.72811"
            stroke="#E0650D"
            stroke-width="2.92375"
        />
        <mask
            id="mask0_2845_26705"
        ...
        >
            <path
                d="M2 9.61045L13.6505 1.5L25.301 9.61045V28.4535H2V9.61045Z"
                fill="black"
            />
        </mask>
        <g mask="url(#mask0_2845_26705)">
            <path
                d="M32.7734 26.3456C30.6552 25.004 25.6419 22.6562 19.7107 22.6562C12.2968 22.6562 9.47238 27.3518 2.7645 27.3518C-3.94338 27.3518 -6.76775 24.6686 -6.76775 24.6686"
                stroke="#E0650D"
                stroke-width="2.92375"
            />
            <path
                d="M32.7734 16.9315C30.6552 15.5899 25.6419 13.2422 19.7107 13.2422C12.2968 13.2422 9.47238 17.9377 2.7645 17.9377C-3.94338 17.9377 -6.76775 15.2546 -6.76775 15.2546"
                stroke="#E0650D"
                stroke-width="2.92375"
            />
            <path
                d="M-6.0625 22.6569C-4.41495 21.0918 0.362943 17.9614 6.29412 17.9614C13.7081 17.9614 16.5325 22.6569 23.2403 22.6569C29.9482 22.6569 33.4787 19.9738 33.4787 19.9738"
                stroke="#E0650D"
                stroke-width="2.92375"
            />
            <path
        ...
        <path
            d="M2 10.7179L13.6505 2.66846L25.301 10.7179V29.5H2V10.7179Z"
            stroke="#E0650D"
            stroke-width="2.92375"
        />
    </svg>
                    ...
                    >
                        <ul className="font-medium flex items-center flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                            <li>
                                <Link
                                    href="/how-it-works"
                                    className="block py-2 px-3 text-white bg-gray-900 rounded md:bg-transparent md:text-gray-900 md:p-0"
                                    aria-current="page"
                                    onClick={() =>
                            ...
                            <li>
                                <Link
                                    href="#"
                                    className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-gray-900 md:p-0"
                                    onClick={() =>
                                        window.location.assign("/how-it-works")
                                    }
                                >
                ...
                >
                    ...
                    >
                        <LinkText
                            size={"32"}
                            weight={"medium"}
                            selected={router.pathname.includes("signup")}
                        >
                            Sign up
                        </LinkText>
                    </Link>
                    <Link
                        href="/how-it-works"
                        style={{ width: "200px", marginTop: "38px" }}
                        onClick={() => setIsOpen(false)}
                    >
                        <LinkText
                            size={"32"}
                            weight={"medium"}
                            selected={router.pathname.includes("how-it-works")}
                        >
                            How It Works
                        </LinkText>
                    </Link>
                    <Link
                        href="/how-it-works"
                        style={{ width: "56px", marginTop: "20px" }}
                        onClick={() => setIsOpen(false)}
                    >
                        <LinkText
                            size={"32"}
