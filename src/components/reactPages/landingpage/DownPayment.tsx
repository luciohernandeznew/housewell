...
const DownPayment: FC = () => {
    ...
    return (
        <>
            <div className="rounded-2xl bg-[#F5FEF6] mt-4">
                <div className="grid grid-cols-12 relative">
                    <div className="col-span-4 max-lg:col-span-12 p-8 z-30 max-lg:hidden bg-[#F5FEF6]">
                        <Transition refElement={tempRef}>
                            ...
                            <div className="font-austin text-5xl max-[1767px]:text-4xl max-lg:text-4xl max-md:text-3xl">
                                ...
                                <div>no realtor required</div>
                            </div>
                            <div className="border-[#B3B9B3] border-t-[1px] mt-16 w-1/4"></div>
                            <div className="font-mint text-lg mt-4 max-lg:text-md max-md:text-sm max-[1767px]:text-sm ">
                    ...
                    <div className="hidden absolute w-full h-[400px] bg-[#F5FEF6] mt-[400px] z-30 max-lg:block max-sm:mt-[350px] max-[480px]:mt-[250px] max-[350px]:mt-[150px]">
                        <div className="w-full bg-[#F5FEF6]"></div>
                    </div>
                    <div className="col-span-8 max-lg:col-span-12">
                        <div className="scale-90 flex pt-8 justify-center w-full z-10 max-[1767px]:scale-85 max-[1120px]:scale-80 max-[1060px]:scale-75 max-[634px]:scale-70 max-[562px]:scale-60 max-[480px]:scale-50 max-[420px]:scale-40 max-[345px]:scale-30">
                            <div ref={ref} />
                    ...
                    <div className="hidden col-span-4 max-lg:col-span-12 p-8 z-30 max-lg:block max-lg:mt-[400px] max-sm:[350px] max-[500px]:mt-[320px] max-[450px]:mt-[230px] max-[345px]:mt-[250px]">
                        <Transition refElement={backRef}>
                            <div ref={backRef} />
                            <div className="font-austin text-5xl max-[1767px]:text-4xl max-lg:text-4xl max-md:text-3xl">
                                <div>Build your offer with</div>
                                <div>everything you need,</div>
                            ...
                            <div className="font-mint text-lg mt-4 max-lg:text-md max-md:text-sm max-[1767px]:text-sm ">
                                ...
                                experience—no need to be a realtor or to be an
                                expert in contract law. Every contract is
                                formatted with all the same legal requirements
                                that a realtor uses.
                            </div>
                            <SecondaryButton
                                hasArrow
