        ...
        <>
            ...
            <div className="font-austin mx-80 max-2xl:mx-60 max-xl:mx-40 max-lg:mx-20 max-md:mx-10 max-sm:mx-5">
                ...
                >
                    ...
                    Yes, but only once you complete the sale. You can list with Housewell for free, and we charge a flat $2000 commission when you sell your home (not including any buyers agent). This is a fraction of the typical 6% commission charged by traditional agents.
