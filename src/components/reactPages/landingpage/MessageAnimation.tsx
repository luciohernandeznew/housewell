        ...
        <>
            <div className="rounded-2xl bg-[#FCFDF1] font-austin mt-4 pt-10">
                <div className="grid grid-cols-12 lg:gap-8">
                    <div className="col-span-8 max-lg:col-span-12 max-md:min-h-[20rem] z-30 max-[1564px]:scale-95">
                    ...
                    <div className="col-span-4 max-lg:col-span-12 max-lg:pt-5 px-5 pb-5 z-30">
                        <Transition refElement={tempRef}>
                            ...
                            <div className="border-[#B3B9B3] border-t-[1px] mt-64 max-[1023px]:mt-16 w-1/4 max-[1767px]:mt-[350px] max-[1280px]:mt-[440px] max-[1024px]:mt-[500px]"></div>
